...
var StyledLogo = styled__default['default'].img(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  margin-left: 24px;\n  margin-right: 64px;\n  max-width: fit-content;\n"], ["\n  margin-left: 24px;\n  margin-right: 64px;\n  max-width: fit-content;\n"])));
var Logo$1 = function (_a) {
    var isPushed = _a.isPushed, isMobile = _a.isMobile, togglePush = _a.togglePush; _a.isDark; var href = _a.href;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null, isMobile ? React__default['default'].createElement(StyledLogo, { src: "/images/egg/mobile_logo.png", width: "65px" }) : React__default['default'].createElement(StyledLogo, { src: "/images/egg/logo.png", width: "205px" })));
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "0px" }, isPushed ? (React__default['default'].createElement(Icon$L, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$K, { width: "24px", color: "textSubtle" }))),
...
var PanelBody = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, isMobile = _a.isMobile, links = _a.links, socilas = _a.socilas;
    ...
    return (React__default['default'].createElement(Container$3, null,
        ...
        React__default['default'].createElement("div", { style: { display: 'flex' } }, socilas.map(function (entry) {
            var Icon = Icons[entry.icon];
                ...
                return (React__default['default'].createElement(React__default['default'].Fragment, null, isPushed &&
                    entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                        React__default['default'].createElement(MenuLink, { href: entry.href },
                            React__default['default'].createElement("div", { style: { display: 'flex', margin: 'auo' } },
                                React__default['default'].createElement("img", { style: { height: '30px' }, src: entry.imageLink }))))); })));
            }
            return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
                React__default['default'].createElement(MenuLink, { href: entry.href, onClick: handleClick },
                    React__default['default'].createElement("div", { style: { display: 'flex', margin: 'auo' } },
                        React__default['default'].createElement("img", { style: { height: '25px' }, src: entry.imageLink })))));
        }))));
};
var templateObject_1$B;
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Logo$1, { isPushed: isPushed, isMobile: isMobile, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React__default['default'].createElement(StyledLinkContainer, null, socilas.map(function (entry) {
            ...
            React__default['default'].createElement(StyledLinkContainer, null, links.map(function (entry) {
                return (React__default['default'].createElement(StyledNavLink, { key: entry.href, isActive: entry.href === location.pathname },
                    React__default['default'].createElement(MenuLink, { href: entry.href },
                        React__default['default'].createElement("div", { style: { display: 'flex', margin: 'auo' } },
                            React__default['default'].createElement("img", { style: { height: '30px' }, src: entry.imageLink }),
                            React__default['default'].createElement("div", { style: { margin: 'auto', marginLeft: '5px' } }, entry.label)))));
            })),
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout }),
                profile && React__default['default'].createElement(Avatar, { profile: profile }))),
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, socilas: socilas, priceLink: priceLink }),
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#bbb8bf", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
