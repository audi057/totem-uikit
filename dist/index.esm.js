...
var StyledLogo = styled.img(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  margin-left: 24px;\n  margin-right: 64px;\n  max-width: fit-content;\n"], ["\n  margin-left: 24px;\n  margin-right: 64px;\n  max-width: fit-content;\n"])));
var Logo$1 = function (_a) {
    var isPushed = _a.isPushed, isMobile = _a.isMobile, togglePush = _a.togglePush; _a.isDark; var href = _a.href;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = (React.createElement(React.Fragment, null, isMobile ? React.createElement(StyledLogo, { src: "/images/egg/mobile_logo.png", width: "65px" }) : React.createElement(StyledLogo, { src: "/images/egg/logo.png", width: "205px" })));
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "0px" }, isPushed ? (React.createElement(Icon$L, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$K, { width: "24px", color: "textSubtle" }))),
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null,
        ...
        React.createElement("div", { style: { display: 'flex' } }, socilas.map(function (entry) {
            var Icon = Icons[entry.icon];
            ...
            return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
                React.createElement(MenuLink, { href: entry.href, onClick: handleClick },
                    React.createElement("div", { style: { display: 'flex', margin: 'auo' } },
                        React.createElement("img", { style: { height: '25px' }, src: entry.imageLink })))));
        }))));
};
var templateObject_1$B;
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(Logo$1, { isPushed: isPushed, isMobile: isMobile, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React.createElement(StyledLinkContainer, null, socilas.map(function (entry) {
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, socilas: socilas, priceLink: priceLink }),
